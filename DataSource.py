...
class DataSource(object):
    ...
    def __init__(self):
        ...
        self.orderStreams = []
        for i in range(300): # Dummy number which ensures that datasource gets allocated completely and results are printed
            self.orderStreams.append({"Header": i+1, "Lines": [{"Product": "A", "Quantity": randint(0,7)}, {"Product": "B", "Quantity": randint(0,7)}, {"Product": "C", "Quantity": randint(0,7)}, {"Product": "D", "Quantity": randint(0,7)}, {"Product": "E", "Quantity": randint(0,7)}]})
